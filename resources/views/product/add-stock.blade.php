...
<div class="col-12 grid-margin createtable">
          ...
          @endif
                  ...
                  <form class="form-sample"  action="{{url('/update-add-product')}}" method="post" enctype="multipart/form-data"  id="theform">
                          {{csrf_field()}}
                    <div class="row">
                ...
                <input type="hidden" name="id" value="{{$ed_prod->id}}">
                      ...
                      <div class="col-md-12">
                        ...
                        <label class="col-sm-2 col-form-label">Current Stock</label><span style="color:red">*</span>
                          <div class="col-sm-9">
                         <lable style="color:red"> {{$ed_prod->product_qty}}</lable>
                          </div>
                        </div>
                      </div>
