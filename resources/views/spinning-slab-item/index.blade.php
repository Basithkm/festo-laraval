                            ...
                            <td>{{$category->name}}</td>
                                    ...
                                    @foreach($category->slab as $slabitem)
                                     ...
                                     @endforeach
                                        ...
                                        <td><a href="{{url('spinning-wheel-slab-item-edit/'.$category->id)}}" class="btn btnsmall btn-outline-secondary btn-icon-text">Edit<i class="zmdi zmdi-edit zmdi-hc-fw"></i></a>
