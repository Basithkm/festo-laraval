                ...
                <div class="card-body">
                    <div class="row ">
                        <div class="col-md-6 col-sm-6 col-xs-12">
                             <h4 class="card-title">Order List (Last 100 Records)</h4></h4>
                        </div>
                  ...
                  <form class="form-sample"  action="{{url('order-country-wise')}}" method="get" >
                          {{csrf_field()}}
                    <div class="row">
                    ...
                    @foreach($currency as $cate)
                      <option value="{{$cate->code}}">{{$cate->country}}</option>
                    @endforeach
                    </select>
                    </div>
